# Generated by Django 4.1 on 2023-11-28 02:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('user', '0013_alter_user_options_alter_user_managers_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='password',
            field=models.CharField(default=1, max_length=20, unique=True, verbose_name='Senha'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='user',
